...
export const NotificationManager = () => {
    ...
    function create_notification(header, message, rust_notification_id, duration_ms=3000) {
        const js_notification_id = Store.addNotification({
            ...
            onRemoval: (id, removed_by) => {
                set_notifications(prev => prev.filter(notification => notification.js_notification_id !== id));
            }
          });

        set_notifications(prev => [...prev, { js_notification_id: js_notification_id, rust_notification_id: rust_notification_id }]);
    }
